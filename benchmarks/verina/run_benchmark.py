...
from benchmarks.verina.fetch_dataset import load_mbpp_task, list_available_tasks, MBPPTask
...
def _run_counterfactual_tests(
    ...
    from benchmarks.verina.variant_generator import generate_variants, compare_circuits
